...
function peg$parse(input, options) {
	...
	var peg$e1 = peg$literalExpectation('let', false)
	...
	var peg$e7 = peg$literalExpectation('fun', false)
	...
	var peg$f1 = function (exprs) {
		return {
			type: 'Program',
			exprs,
		}
	}
	var peg$f2 = function (name, val, body) {
		return { type: 'let', name, val, body }
	}
	var peg$f3 = function (cond, thenExpr) {
		if (typeof elseExpr === 'undefined') {
			return { type: 'if', cond, thenExpr }
		} else {
			return { type: 'if', cond, thenExpr, elseExpr }
		}
	}
	var peg$f4 = function (param, body) {
		return { type: 'fun', param, body }
	}
	var peg$f5 = function (func, arg) {
